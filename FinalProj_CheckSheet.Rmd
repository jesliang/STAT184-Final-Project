...
(A) .Rmd Line numbers where at least two different data sources are imported: 28-36


(B) .Rmd Line numbers for inspecting data intake: 68-75, 84-89, 93-100, 109-114
...
(A) .Rmd Line number(s) for general data wrangling: 45-63, 


(B) .Rmd Line number(s) for a join operation: 120-122


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 125-128


(D) .Rmd Line number(s) for use of regular expressions: 139-146


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 62-63, 127, 159, 172, 187, 204
...
(A) .Rmd Line number(s) for use of multiple different geoms:  161, 174, 175, 189, 206, 207

(B) .Rmd Line number(s) for use of multiple aesthetics:  161, 162, 174-177, 189-191, 206-209

(C) .Rmd Line number(s) for use of layered graphics:  205-207
